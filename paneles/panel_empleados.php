    ...
    <body>
        <div class="container">
            ...
            <div class="main">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th><a href="../acciones/actualizar_empleado.php?id_empleado=<?= $row['id_empleado'] ?>" class="users-table--edit">Editar</a></th>
                            <th><a href="../acciones/eliminar_empleado.php?id_empleado=<?= $row['id_empleado'] ?>" class="users-table--delete">Eliminar</a></th>
                        </tr>
                        <?php 
                            endwhile;
                        ?>
                ...
                <a href="../acciones/crear_empleado.php"><button class="btn_crear">Nuevo Empleado</button></a>
                <div class="paginador">
                    <ul>
                        <?php
                            /*if(pagina != 1){*/
