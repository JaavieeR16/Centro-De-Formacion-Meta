<?php
    ...
    /* PAGINADOR */
    $sql_register = mysqli_query($conectar,"SELECT COUNT(*) AS total_registros FROM usuarios_alumnos");
    ...
    $query = mysqli_query($conectar,"SELECT * FROM usuarios_alumnos LIMIT $desde,$por_pagina");
...
<html lang="es">
    ...
    <body>
        <div class="container">
            ...
            <div class="main">
                <table>
                    <caption>USUARIOS ALUMNOS</caption>
                    <thead>
                        <tr>
                            <th>Identificador</th>
                            <th>Usuario</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th><a href="../acciones/actualizar_alumno.php?id_alumno=<?= $row['id_alumno'] ?>" class="users-table--edit">Editar</a></th>
                            <th><a href="../acciones/eliminar_alumno.php?id_alumno=<?= $row['id_alumno'] ?>" class="users-table--delete">Eliminar</a></th>
                        </tr>
                        <?php 
                            endwhile;
                        ?>
                ...
                <a href="../acciones/crear_alumno.php"><button class="btn_crear">Nuevo Alumno</button></a>
                <div class="paginador">
                    <ul>
                        <?php
                            /*if(pagina != 1){*/
