<?php
    ...
    /* PAGINADOR */
    $sql_register = mysqli_query($conectar,"SELECT COUNT(*) AS total_registros FROM cursos");
    ...
    $query = mysqli_query($conectar,"SELECT * FROM cursos LIMIT $desde,$por_pagina");
    ...
    <body>
        <div class="container">
            ...
            <div class="main">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th> <?= $row['siglas'] ?> </th>
                            <th> <?= $row['horas'] ?> </th>
                            <th> <?= $row['fk_idcategoria'] ?> </th>

                            <th><a href="../acciones/actualizar_curso.php?id_curso=<?= $row['id_curso'] ?>" class="users-table--edit">Editar</a></th>
                            <th><a href="../acciones/eliminar_curso.php?id_curso=<?= $row['id_curso'] ?>" class="users-table--delete">Eliminar</a></th>
                        </tr>
                        <?php 
                            endwhile;
                        ?>
                ...
                <a href="../acciones/crear_curso.php"><button class="btn_crear">Nuevo Curso</button></a>
                <div class="paginador">
                    <ul>
                        <?php
                            /*if(pagina != 1){*/
