<?php
    ...
    /* PAGINADOR */
    $sql_register = mysqli_query($conectar,"SELECT COUNT(*) AS total_registros FROM categorias_cursos");
    ...
    $query = mysqli_query($conectar,"SELECT * FROM categorias_cursos LIMIT $desde,$por_pagina");
    ...
    <body>
        <div class="container">
            ...
            <div class="main">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th> <?= $row['nombre'] ?> </th>
                            <th> <?= $row['numero_cursos'] ?> </th>

                            <th><a href="../acciones/actualizar_categoria.php?id_categoria=<?= $row['id_categoria'] ?>" class="users-table--edit">Editar</a></th>
                            <th><a href="../acciones/eliminar_categoria.php?id_categoria=<?= $row['id_categoria'] ?>" class="users-table--delete">Eliminar</a></th>
                        </tr>
                        <?php 
                            endwhile;
                        ?>
                ...
                <a href="../acciones/crear_categoria.php"><button class="btn_crear">Nuevo Curso</button></a>
                <div class="paginador">
                    <ul>
                        <?php
                            /*if(pagina != 1){*/
