<?php
    ...
    $sql = "SELECT * FROM categorias_cursos WHERE id_categoria = '$id_categoria'";
        ...
        <div class="container">
            ...
            <div class="main">
                <form action="editar_categoria.php" method="post">
                    ...
                    <input type="text" name="numero_cursos" placeholder="Numero de cursos" value="<?= $row['numero_cursos'] ?>">
