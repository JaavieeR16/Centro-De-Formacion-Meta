    ...
    <body>
        <div class="container">
            ...
            <div class="div-padre-form-nuevo">
                    <form action="validar-nuevo-categoria.php" method="post">
                        <h1>Nuevo Categoria</h1>
                        <input type="text" name="nombre" id="nombre" placeholder="Ingrese nombre" require>
                        <input type="text" name="numero_cursos" id="numero_cursos" placeholder="Ingrese numero de cursos" require>
                        <input type="submit" value="Validar Categoria" name="nuevo-empleado">
                    </form>
                </div>
            </div>
        </div>
