    ...
    <body>
        <div class="container">
            ...
            <div class="div-padre-form-nuevo">
                    <form action="validar-nuevo-rol.php" method="post">
                        <h1>Nuevo Rol</h1>
                        <input type="text" name="nombre" id="nombre" placeholder="Ingrese nombre" require>
                        <input type="text" name="descripcion" id="descripcion" placeholder="Ingrese descripcion" require>
                        <input type="submit" value="Validar Rol" name="nuevo-empleado">
                    </form>
                </div>
            </div>
        </div>
